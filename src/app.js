...
app.use(cors(
    {
        origin: ['http://localhost:4200', 'http://front.victor.xyz:31371', 'http://front.victor.xyz:30000', 'https://manager.vjdev.xyz'],
...
const movies_lmhd = require('./schedules/movies/scraping_lmhd')
...
app.use('/api/v1/scraping/movies', movies_lmhd)
